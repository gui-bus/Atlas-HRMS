  ...
  return (
    ...
    >
      ...
      <div
        ...
        data-side={side}
        className={cn(
          "relative z-10 hidden h-svh w-(--sidebar-width) transition-[width,opacity] duration-200 ease-linear md:flex group-data-[collapsible=offcanvas]:w-0 group-data-[collapsible=offcanvas]:opacity-0 group-data-[collapsible=offcanvas]:pointer-events-none",
      ...
      >
        <div
          ...
          className="flex size-full flex-col bg-sidebar group-data-[collapsible=offcanvas]:opacity-0 group-data-[collapsible=offcanvas]:pointer-events-none"
        >
          {children}
        </div>
      </div>
...
function SidebarInset({ className, ...props }: React.ComponentProps<"main">) {
  return (
    <main
      ...
      className={cn(
        "relative flex w-full flex-1 flex-col bg-background md:ml-2 md:peer-data-[variant=inset]:m-2 md:peer-data-[variant=inset]:peer-data-[state=collapsed]:ml-2",
        className,
      )}
      {...props}
    />
