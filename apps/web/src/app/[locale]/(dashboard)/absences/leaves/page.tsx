  ...
  const columns = [
    ...
    columnHelper.accessor("type", {
      ...
      cell: (info) => {
        ...
        return <span className="text-foreground font-medium">{typeMap[info.getValue()]}</span>;
      },
    }),
        ...
        return (
          <div className="flex items-center gap-1.5">
            ...
            <Button
              ...
              onClick={() => router.push(`/${locale}/absences/leaves/${row.id}/reject`)}
            >
              <X className="h-4 w-4" />
            </Button>
          </div>
              ...
              <tbody>
                {isLoading ? (
                  ...
                  <tr className="border-0">
                    ...
                    >
                      Nenhuma licença ou atestado encontrado.
                    </td>
                  </tr>
                ) : (
